...
r4 update changes to a multi-threaded worker approach
"""
...
# actual solver function that implements multi-threaded branch and bound solver
...
# worker threads that implement an independent BnB solver
    ...
    while q and nIterations < maxIter:
        ...
        if solStruct['coverSet']:
            ...
            if len(solStruct['coverSet']) < bestCost:
                ...
                # pass values back to root process
...
# solve a single instance of BnB problem, including branch and check
...
# multi-threaded join function (from library)
